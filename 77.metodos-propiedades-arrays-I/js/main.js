...
console.log(frutas.length) // Números de elementos del array
...
// Método sort es usado para ordenar elementos del array usando el criterio ASCII

frutas.sort();
console.log(frutas);

// Método reverse invierte el orden de elementos en el array
