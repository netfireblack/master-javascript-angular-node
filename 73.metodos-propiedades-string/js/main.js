...
console.log(nombre.length); // Devuelve n° de caracteres
...
console.log(password.slice(2, 5)); // Devuelve el fragmento desde la primera posición incluida hasta la segunda posición excluida
