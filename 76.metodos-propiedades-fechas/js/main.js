...
// 1° Opción pasándo argumentos: año, mes (indexado a cero), día, hora, minutos, segundos, ms

let fechaNacimiento = new Date(1990, 1, 11); // 11 Febrero de 1990
console.log(fechaNacimiento);

// 2° Opción pasándo argumento fecha-string 'yyyy-MM-dd' (meses no indexados a cero)

let fechaExpedicion = new Date('2021/03/15'); // 15 de Marzo de 2021
console.log(fechaExpedicion);

// 3° Opción pasándo argumento en milisegundos desde era Epoch

let fechaAleatoria = new Date(132345321321546);
console.log(fechaAleatoria);

// Métodos de instancias de clase Date
